package com.aws.lambda.core.generated
...
import com.aws.lambda.core.api
import com.aws.lambda.core.createComponents
...
class GeneratedApiFactory<T : ComponentsProvider> : ApiFactory<T> {
    override val api: Api<T> = com.aws.lambda.core.api as Api<T>
    override val config: ApplicationConfig = com.aws.lambda.core.config
}
